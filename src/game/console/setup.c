...
CONSOLE_COMMAND *g_ConsoleCommands[] = {
    &g_Console_Cmd_Teleport, &g_Console_Cmd_Fly,
    ...
    &g_Console_Cmd_PlayDemo, &g_Console_Cmd_ExitToTitle,
    &g_Console_Cmd_ExitGame, &g_Console_Cmd_Die,
    &g_Console_Cmd_Config,   &g_Console_Cmd_Pos,
    &g_Console_Cmd_Heal,     &g_Console_Cmd_SetHealth,

...
#define Collide_TestCollision ((int32_t __cdecl (*)(ITEM_INFO *item, const ITEM_INFO *lara_item))0x0043F9B0)
...
#define Level_LoadRooms ((BOOL __cdecl (*)(HANDLE handle))0x00449AB0)
#define AdjustTextureUVs ((void __cdecl (*)(bool reset_uv_add))0x00449E50)
#define Level_LoadObjects ((BOOL __cdecl (*)(HANDLE handle))0x00449EF0)
#define Level_LoadSprites ((BOOL __cdecl (*)(HANDLE handle))0x0044A470)
#define Level_LoadItems ((BOOL __cdecl (*)(HANDLE handle))0x0044A5B0)
#define Level_LoadDepthQ ((BOOL __cdecl (*)(HANDLE handle))0x0044A790)
#define Level_LoadPalettes ((BOOL __cdecl (*)(HANDLE handle))0x0044A920)
#define Level_LoadCameras ((BOOL __cdecl (*)(HANDLE handle))0x0044A9A0)
#define Level_LoadSoundEffects ((BOOL __cdecl (*)(HANDLE handle))0x0044AA00)
#define Level_LoadBoxes ((BOOL __cdecl (*)(HANDLE handle))0x0044AA60)
#define Level_LoadAnimatedTextures ((BOOL __cdecl (*)(HANDLE handle))0x0044AC90)
...
#define S_PrintShadow ((void __cdecl (*)(int16_t radius, const BOUNDS_16 *bounds, const ITEM_INFO *item))0x00450F80)

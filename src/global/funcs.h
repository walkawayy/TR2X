...
#define Gun_GetNewTarget ((void __cdecl (*)(WEAPON_INFO *winfo))0x0042EF30)
#define Gun_FindTargetPoint ((void __cdecl (*)(ITEM_INFO *item, GAME_VECTOR *target))0x0042F150)
#define Gun_AimWeapon ((void __cdecl (*)(WEAPON_INFO *winfo, LARA_ARM *arm))0x0042F200)
#define Gun_FireWeapon ((int32_t __cdecl (*)(int32_t weapon_type, ITEM_INFO *target, ITEM_INFO *src, PHD_ANGLE *angles))0x0042F2D0)

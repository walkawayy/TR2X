...
#define Creature_Neck ((void __cdecl (*)(ITEM_INFO *item, int16_t required))0x0040FF60)
...
#define Room_GetHeight ((int32_t __cdecl (*)(const FLOOR_INFO *floor, int32_t x, int32_t y, int32_t z))0x00414E80)
...
#define Item_IsTriggerActive ((int32_t __cdecl (*)(ITEM_INFO *item))0x004158D0)
#define Room_GetCeiling ((int32_t __cdecl (*)(const FLOOR_INFO *floor, int32_t x, int32_t y, int32_t z))0x00415930)
#define Room_GetDoor ((int16_t __cdecl (*)(FLOOR_INFO *floor))0x00415B90)
...
#define DragonCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00417AC0)
...
#define LaraBubbles ((void __cdecl (*)(ITEM_INFO *item))0x0041C910)
#define ControlBubble1 ((void __cdecl (*)(int16_t fx_num))0x0041C990)
#define Splash ((void __cdecl (*)(ITEM_INFO *item))0x0041CA90)
...
#define finish_level_effect ((void __cdecl (*)(ITEM_INFO *item))0x0041CF40)
#define turn180_effect ((void __cdecl (*)(ITEM_INFO *item))0x0041CF50)
#define floor_shake_effect ((void __cdecl (*)(ITEM_INFO *item))0x0041CF70)
#define lara_normal_effect ((void __cdecl (*)(ITEM_INFO *item))0x0041D010)
#define BoilerFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D050)
#define FloodFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D070)
#define RubbleFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D100)
#define ChandelierFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D130)
#define ExplosionFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D160)
#define PistonFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D190)
#define CurtainFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D1B0)
#define StatueFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D1D0)
#define SetChangeFX ((void __cdecl (*)(ITEM_INFO *item))0x0041D1F0)
...
#define DoChimeSound ((void __cdecl (*)(ITEM_INFO *item))0x0041D360)
#define ControlClockChimes ((void __cdecl (*)(int16_t item_num))0x0041D3C0)
#define SphereOfDoomCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x0041D430)
#define SphereOfDoom ((void __cdecl (*)(int16_t item_num))0x0041D560)
#define DrawSphereOfDoom ((void __cdecl (*)(ITEM_INFO *item))0x0041D650)
#define lara_hands_free ((void __cdecl (*)(ITEM_INFO *item))0x0041D780)
#define flip_map_effect ((void __cdecl (*)(ITEM_INFO *item))0x0041D790)
#define draw_right_gun ((void __cdecl (*)(ITEM_INFO *item))0x0041D7A0)
#define draw_left_gun ((void __cdecl (*)(ITEM_INFO *item))0x0041D7F0)
#define swap_meshes_with_meshswap1 ((void __cdecl (*)(ITEM_INFO *item))0x0041D840)
#define swap_meshes_with_meshswap2 ((void __cdecl (*)(ITEM_INFO *item))0x0041D8B0)
#define swap_meshes_with_meshswap3 ((void __cdecl (*)(ITEM_INFO *item))0x0041D920)
#define invisibility_on ((void __cdecl (*)(ITEM_INFO *item))0x0041D9C0)
#define invisibility_off ((void __cdecl (*)(ITEM_INFO *item))0x0041D9D0)
#define dynamic_light_on ((void __cdecl (*)(ITEM_INFO *item))0x0041D9F0)
#define dynamic_light_off ((void __cdecl (*)(ITEM_INFO *item))0x0041DA00)
#define reset_hair ((void __cdecl (*)(ITEM_INFO *item))0x0041DA10)
#define AssaultStart ((void __cdecl (*)(ITEM_INFO *item))0x0041DA20)
#define AssaultStop ((void __cdecl (*)(ITEM_INFO *item))0x0041DA50)
#define AssaultReset ((void __cdecl (*)(ITEM_INFO *item))0x0041DA70)
#define AssaultFinished ((void __cdecl (*)(ITEM_INFO *item))0x0041DA90)
...
#define DrawXianLord ((void __cdecl (*)(ITEM_INFO *item))0x0041EAE0)
#define XianDamage ((void __cdecl (*)(ITEM_INFO *item, CREATURE_INFO *xian, int32_t damage))0x0041EEE0)
...
#define SelectMeshes ((void __cdecl (*)(INVENTORY_ITEM *inv_item))0x00423470)
#define AnimateInventoryItem ((int32_t __cdecl (*)(INVENTORY_ITEM *inv_item))0x00423500)
#define DrawInventoryItem ((void __cdecl (*)(INVENTORY_ITEM *inv_item))0x00423590)
...
#define Inv_RingInit ((void __cdecl (*)(RING_INFO *ring, int16_t type, INVENTORY_ITEM **list, int16_t qty, int16_t current, IMOTION_INFO *imo))0x00425000)
#define Inv_RingGetView ((void __cdecl (*)(RING_INFO *ring, PHD_3DPOS *viewer))0x00425110)
#define Inv_RingLight ((void __cdecl (*)(RING_INFO *ring))0x00425170)
#define Inv_RingCalcAdders ((void __cdecl (*)(RING_INFO *ring, int16_t rotation_duration))0x004251B0)
#define Inv_RingDoMotions ((void __cdecl (*)(RING_INFO *ring))0x004251E0)
#define Inv_RingRotateLeft ((void __cdecl (*)(RING_INFO *ring))0x00425320)
#define Inv_RingRotateRight ((void __cdecl (*)(RING_INFO *ring))0x00425350)
#define Inv_RingMotionInit ((void __cdecl (*)(RING_INFO *ring, int16_t frames, int16_t status, int16_t status_target))0x00425380)
#define Inv_RingMotionSetup ((void __cdecl (*)(RING_INFO *ring, int16_t status, int16_t status_target, int16_t frames))0x004253F0)
#define Inv_RingMotionRadius ((void __cdecl (*)(RING_INFO *ring, int16_t target))0x00425420)
#define Inv_RingMotionRotation ((void __cdecl (*)(RING_INFO *ring, int16_t rotation, int16_t target))0x00425450)
#define Inv_RingMotionCameraPos ((void __cdecl (*)(RING_INFO *ring, int16_t target))0x00425480)
#define Inv_RingMotionCameraPitch ((void __cdecl (*)(RING_INFO *ring, int16_t target))0x004254B0)
#define Inv_RingMotionItemSelect ((void __cdecl (*)(RING_INFO *ring, INVENTORY_ITEM *inv_item))0x004254D0)
#define Inv_RingMotionItemDeselect ((void __cdecl (*)(RING_INFO *ring, INVENTORY_ITEM *inv_item))0x00425530)
#define Init_Requester ((void __cdecl (*)(REQUEST_INFO *req))0x004255A0)
#define Remove_Requester ((void __cdecl (*)(REQUEST_INFO *req))0x00425630)
#define ReqItemCentreAlign ((void __cdecl (*)(REQUEST_INFO *req, TEXTSTRING *txt))0x004256E0)
#define ReqItemLeftalign ((void __cdecl (*)(REQUEST_INFO *req, TEXTSTRING *txt))0x00425700)
#define ReqItemRightalign ((void __cdecl (*)(REQUEST_INFO *req, TEXTSTRING *txt))0x00425760)
#define Display_Requester ((int32_t __cdecl (*)(REQUEST_INFO *req, int32_t des, int32_t backgrounds))0x004257C0)
#define SetRequesterHeading ((void __cdecl (*)(REQUEST_INFO *req, char *text1, uint32_t flags1, char *text2, uint32_t flags2))0x00426030)
#define RemoveAllReqItems ((void __cdecl (*)(REQUEST_INFO *req))0x004260E0)
#define ChangeRequesterItem ((void __cdecl (*)(REQUEST_INFO *req, int32_t item, char *text1, uint32_t flags1, char *text2, uint32_t flags2))0x00426100)
#define AddRequesterItem ((void __cdecl (*)(REQUEST_INFO *req, char *text1, uint32_t flags1, char *text2, uint32_t flags2))0x004261C0)
...
#define set_arm_info ((void __cdecl (*)(LARA_ARM *arm, int32_t frame))0x0042CF60)
...
#define Lara_TestClimbPos ((int32_t __cdecl (*)(ITEM_INFO *item, int32_t front, int32_t right, int32_t origin, int32_t height, int32_t *shift))0x0042E290)
#define Lara_DoClimbLeftRight ((void __cdecl (*)(ITEM_INFO *item, COLL_INFO *coll, int32_t result, int32_t shift))0x0042E360)
...
#define LaraTargetInfo ((void __cdecl (*)(WEAPON_INFO *winfo))0x0042ED90)
#define LaraGetNewTarget ((void __cdecl (*)(WEAPON_INFO *winfo))0x0042EF30)
#define find_target_point ((void __cdecl (*)(ITEM_INFO *item, GAME_VECTOR *target))0x0042F150)
#define AimWeapon ((void __cdecl (*)(WEAPON_INFO *winfo, LARA_ARM *arm))0x0042F200)
#define FireWeapon ((int32_t __cdecl (*)(int32_t weapon_type, ITEM_INFO *target, ITEM_INFO *src, PHD_ANGLE *angles))0x0042F2D0)
#define HitTarget ((void __cdecl (*)(ITEM_INFO *item, GAME_VECTOR *hitpos, int32_t damage))0x0042F640)
...
#define DoFlareLight ((int32_t __cdecl (*)(XYZ_32 *pos, int32_t flare_age))0x0042F7A0)
#define DoFlareInHand ((void __cdecl (*)(int32_t flare_age))0x0042F840)
#define DrawFlareInAir ((void __cdecl (*)(ITEM_INFO *item))0x0042F920)
...
#define OnDrawBridge ((int32_t __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y))0x00435590)
#define DrawBridgeFloor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435650)
#define DrawBridgeCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435690)
#define DrawBridgeCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x004356D0)
...
#define LiftFloorCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *floor, int32_t *ceiling))0x00435820)
#define LiftFloor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x004359A0)
#define LiftCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x004359E0)
#define BridgeFlatFloor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435A20)
#define BridgeFlatCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435A40)
#define GetOffset ((int32_t __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t z))0x00435A60)
#define BridgeTilt1Floor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435AA0)
#define BridgeTilt1Ceiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435AD0)
#define BridgeTilt2Floor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435B10)
#define BridgeTilt2Ceiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00435B40)
...
#define Targetable ((int32_t __cdecl (*)(ITEM_INFO *item, AI_INFO *info))0x00435E00)
...
#define ShotLara ((int32_t __cdecl (*)(ITEM_INFO *item, AI_INFO *info, BITE_INFO *gun, int16_t extra_rotation, int32_t damage))0x00436100)
...
#define PickUpCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00437E70)
#define SwitchCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x004382F0)
#define SwitchCollision2 ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00438500)
#define DetonatorCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00438600)
#define KeyHoleCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00438840)
#define PuzzleHoleCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *lara_item, COLL_INFO *coll))0x00438A80)
...
#define SkidooCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *litem, COLL_INFO *coll))0x0043CF60)
#define SkidooBaddieCollision ((void __cdecl (*)(ITEM_INFO *skidoo))0x0043D060)
#define TestHeight ((int32_t __cdecl (*)(ITEM_INFO *item, int32_t z_off, int32_t x_off, XYZ_32 *pos))0x0043D260)
#define DoShift ((int32_t __cdecl (*)(ITEM_INFO *skidoo, XYZ_32 *pos, XYZ_32 *old))0x0043D320)
#define DoDynamics ((int32_t __cdecl (*)(int32_t height, int32_t fall_speed, int32_t *y))0x0043D5A0)
#define GetCollisionAnim ((int32_t __cdecl (*)(ITEM_INFO *skidoo, XYZ_32 *moved))0x0043D600)
#define DoSnowEffect ((void __cdecl (*)(ITEM_INFO *skidoo))0x0043D690)
#define SkidooDynamics ((int32_t __cdecl (*)(ITEM_INFO *skidoo))0x0043D7D0)
#define SkidooUserControl ((int32_t __cdecl (*)(ITEM_INFO *skidoo, int32_t height, int32_t *pitch))0x0043DC70)
#define SkidooCheckGetOffOK ((int32_t __cdecl (*)(int32_t direction))0x0043DE30)
#define SkidooAnimation ((void __cdecl (*)(ITEM_INFO *skidoo, int32_t collide, int32_t dead))0x0043DF40)
#define SkidooExplode ((void __cdecl (*)(ITEM_INFO *skidoo))0x0043E220)
...
#define DrawSkidoo ((void __cdecl (*)(ITEM_INFO *item))0x0043EA60)
...
#define Sound_Effect ((void __cdecl (*)(int32_t sample_id, const XYZ_32 *pos, uint32_t flags))0x0043F3C0)
...
#define Collide_GetJointAbsPosition ((void __cdecl (*)(ITEM_INFO *item, XYZ_32 *vec, int32_t joint))0x0043FDC0)
...
#define RollingBallCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *litem, COLL_INFO *coll))0x00441EC0)
#define SpikeCollision ((void __cdecl (*)(int16_t item_num, ITEM_INFO *litem, COLL_INFO *coll))0x00442110)
#define TrapDoorControl ((void __cdecl (*)(int16_t item_num))0x00442270)
#define TrapDoorFloor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x004422C0)
#define TrapDoorCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00442300)
#define OnTrapDoor ((int32_t __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t z))0x00442340)
#define Pendulum ((void __cdecl (*)(int16_t item_num))0x004423F0)
#define FallingBlock ((void __cdecl (*)(int16_t item_num))0x00442500)
#define FallingBlockFloor ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00442610)
#define FallingBlockCeiling ((void __cdecl (*)(ITEM_INFO *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x00442650)
...
#define BGND_Make640x480 ((void __cdecl (*)(uint8_t *bitmap, RGB888 *palette))0x00443990)
#define BGND_AddTexture ((int32_t __cdecl (*)(int32_t tile_idx, BYTE *bitmap, int32_t pal_index, RGB888 *bmp_pal))0x00443B50)

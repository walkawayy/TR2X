...
#define Boat_TestWaterHeight ((int32_t __cdecl (*)(struct ITEM_INFO *item, int32_t z_off, int32_t x_off, struct XYZ_32 *pos))0x0040CE40)
...
#define Item_AlignPosition ((void __cdecl (*)(struct XYZ_32 *vec, struct ITEM_INFO *src_item, struct ITEM_INFO *dst_item))0x00413F50)
#define Lara_MovePosition ((int32_t __cdecl (*)(struct XYZ_32 *vec, struct ITEM_INFO *item, struct ITEM_INFO *lara_item))0x00414090)
...
#define Item_GetFrames ((int32_t __cdecl (*)(const struct ITEM_INFO *item, int16_t *frmptr[], int32_t *rate))0x0041BF90)
#define Item_GetBoundsAccurate ((int16_t *__cdecl (*)(const struct ITEM_INFO *item))0x0041C030)
#define Item_GetBestFrame ((int16_t *__cdecl (*)(const struct ITEM_INFO *item))0x0041C0B0)
...
#define DoFlareLight ((int32_t __cdecl (*)(struct XYZ_32 *pos, int32_t flare_age))0x0042F7A0)
...
#define TestHeight ((int32_t __cdecl (*)(struct ITEM_INFO *item, int32_t z_off, int32_t x_off, struct XYZ_32 *pos))0x0043D260)
#define DoShift ((int32_t __cdecl (*)(struct ITEM_INFO *skidoo, struct XYZ_32 *pos, struct XYZ_32 *old))0x0043D320)
#define DoDynamics ((int32_t __cdecl (*)(int32_t height, int32_t fall_speed, int32_t *y))0x0043D5A0)
#define GetCollisionAnim ((int32_t __cdecl (*)(struct ITEM_INFO *skidoo, struct XYZ_32 *moved))0x0043D600)
...
#define Sound_Effect ((void __cdecl (*)(int32_t sample_id, const struct XYZ_32 *pos, uint32_t flags))0x0043F3C0)
...
#define Collide_GetJointAbsPosition ((void __cdecl (*)(struct ITEM_INFO *item, struct XYZ_32 *vec, int32_t joint))0x0043FDC0)

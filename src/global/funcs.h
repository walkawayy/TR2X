...
#define Inv_AddItem ((int32_t __cdecl (*)(GAME_OBJECT_ID item_num))0x004242F0)
#define Inv_InsertItem ((void __cdecl (*)(INVENTORY_ITEM *inv_item))0x00424B00)
#define Inv_RequestItem ((int32_t __cdecl (*)(GAME_OBJECT_ID item_num))0x00424C30)
#define Inv_RemoveAllItems ((void __cdecl (*)(void))0x00424CB0)
#define Inv_RemoveItem ((int32_t __cdecl (*)(GAME_OBJECT_ID item_num))0x00424CD0)
#define Inv_GetItemOption ((int32_t __cdecl (*)(GAME_OBJECT_ID item_num))0x00424DE0)
...
#define Gun_Rifle_DrawMeshes ((void __cdecl (*)(LARA_GUN_TYPE weapon_type))0x0042BC00)
#define Gun_Rifle_UndrawMeshes ((void __cdecl (*)(LARA_GUN_TYPE weapon_type))0x0042BC40)
#define Gun_Rifle_Ready ((void __cdecl (*)(LARA_GUN_TYPE weapon_type))0x0042BC70)
...
#define Gun_Pistols_SetArmInfo ((void __cdecl (*)(LARA_ARM *arm, int32_t frame))0x0042CF60)
#define Gun_Pistols_Draw ((void __cdecl (*)(LARA_GUN_TYPE weapon_type))0x0042CFB0)
...
#define Collide_GetSpheres ((int32_t __cdecl (*)(const ITEM_INFO *item, SPHERE *spheres, bool world_space))0x0043FAE0)
